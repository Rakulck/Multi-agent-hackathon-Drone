...
export function StepEvidenceCard({ step }: { step: StepEvidence }) {
  return (
    <div className="min-h-0 flex-1 overflow-y-auto rounded-[22px] border border-black/10 bg-white p-4 shadow-[0_14px_40px_rgba(0,0,0,0.07)]">
